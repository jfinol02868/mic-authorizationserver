...
public interface BaseUseCase<T, K> {
    ...
    default T update(T entity, K id) {
        return null;
    }
    ...
    default List<T> findByIds(List<K> id) {
        return List.of();
    }
    ...
    default List<T> filters(String properties, int page, int size, String direction, String... sortProperties) {
        return List.of();
    }
