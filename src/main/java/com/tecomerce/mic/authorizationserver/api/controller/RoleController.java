...
import com.tecomerce.mic.authorizationserver.api.mapper.RoleDTOMapper;
import com.tecomerce.mic.authorizationserver.api.service.RoleApi;
...
@Tags(value = {@Tag(name = "Role", description = "Role API")})
public class RoleController implements RoleApi {
    ...
    @Override
    public ResponseEntity<List<RoleDTO>> createAll(List<RoleDTO> entities) {
    ...
    @Override
    public ResponseEntity<List<RoleDTO>> updateAll(List<RoleDTO> entities) {
    ...
    @Override
    public ResponseEntity<List<RoleDTO>> findByIds(List<String> ids) {
    ...
    @Override
    public ResponseEntity<List<RoleDTO>> filters(String filterProperties, int page, int size, SortEnumDTO direction,
